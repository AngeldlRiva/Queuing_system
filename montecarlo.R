...
# Truncar una normal con media 0 y desviación estándar 1 truncada en [-2,2]
Z_trunc = function(n) {
  muestrax =c()
...
# ahora para seguridad
v_media_SUMAseguridad=c()
for (num_segur in 1:10){
  num_checkin = 2 #este es el numero de controles de seguridad (con sus respectivas colas) en paralelo
  MC=25
...
plot(v_media_SUMAseguridad, type = "o", col = "blue", xlab = "Número de seguridad", ylab = "SUMA_seguridad")
